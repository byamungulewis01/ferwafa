                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#"
                                id="navbarDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    ...
                                    class="hidden-md-down"><?= $_SESSION['fa_user']; ?>&nbsp;</span> </a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="calender.php" aria-expanded="false"><i
                                    class="fa fa-table"></i><span class="hide-menu">Calendar</span></a>
                        </li>
